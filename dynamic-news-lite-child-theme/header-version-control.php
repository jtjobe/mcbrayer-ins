...
<!-- Verification code for Google Apps mail service -->
<meta name="google-site-verification" content="W8lLe2IuzfXH5NFtU5UB20gIYZ_kE9XjGb34NDEX0_U" />
  ...
  <div id="header-wrap">
    ...
    <header id="header" class="container clearfix" role="banner">
      ...
      <div id="logo" class="clearfix">
        <!-- Main Logo -->
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-white-bg.png" class="main-logo"alt="McBrayer Insurance Agency Logo" />
      </div>
      ...
      <div id="header-content" class="clearfix">
        <div class="header-content-container">
          ...
          <!-- Social Icons -->
          <div class="header-social-icons social-icons-wrap clearfix">
